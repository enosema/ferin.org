<template>
  <article class="content-page">
    ...
    <section class="content-section">
      ...
      <p>
        FERIN's <router-link to="/learn/core-concepts">two-plane model</router-link>
      ...
      <div class="capabilities-grid">
        ...
        <div class="capability">
          ...
          <p>
            ...
            items (instances). See
            <router-link to="/build/schema-evolution">Schema Evolution</router-link>.
          </p>
        </div>
        ...
        <div class="capability">
          ...
          <p>
            ...
            history. See <router-link to="/build/temporal-data">Temporal Data</router-link>.
          </p>
        </div>
        ...
        <div class="capability">
          ...
          <p>
            ...
            See <router-link to="/learn/commitments">Commitments</router-link>.
          </p>
        </div>
      </div>
    </section>
