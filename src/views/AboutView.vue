  ...
  <div class="section-view">
    <div class="container">
      ...
      <div class="content-layout">
        <TheSidebar :section="sectionName" />
...
const sectionItems = computed(() => {
  ...
  return items[sectionName.value] || []
})

const currentSectionTitle = computed(() => {
  const item = sectionItems.value.find(i => i.path === route.path)
  return item ? item.label : sectionName.value?.charAt(0).toUpperCase() + sectionName.value?.slice(1) || ''
})
</script>
