  ...
  <article class="content-page">
    ...
    <section class="content-section">
      ...
      <p>
        ...
        depend on the register's <router-link to="/build/risk-management">risk
      ...
      <p>
        ...
        in your <router-link to="/build/register-specification">Register Specification</router-link>
