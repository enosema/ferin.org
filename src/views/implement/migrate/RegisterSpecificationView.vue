    ...
    <section class="content-section">
      ...
      <div class="requirement-cards">
        ...
        <div class="requirement-card new">
          ...
          <router-link to="/understand/commitments" class="link-more">
        ...
        <div class="requirement-card new">
          ...
          <router-link to="/implement/migrate/concepts" class="link-more">
   ...
   - Amendment process</code></pre>
    ...
    <section class="content-section">
      ...
      <div class="next-steps-inline">
        <router-link to="/implement/migrate/governance" class="btn-primary">
          Step 2: Governance Update →
        </router-link>
        <router-link to="/implement/migrate/concepts" class="btn-secondary">
          Document Concepts →
        </router-link>
      </div>
    </section>
